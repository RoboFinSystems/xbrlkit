...
The Arelle parse (:mod:`xbrlkit.parse.to_model`) and the JSON importers
(:mod:`xbrlkit.deserialize`) mint periods. A period's ``id`` is content-derived
so periods dedupe across filings, which means all sources have
